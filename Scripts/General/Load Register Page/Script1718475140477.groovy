...
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_PHNG KHM GROUP21/a_y'), 10)

WebUI.click(findTestObject('Object Repository/Page_PHNG KHM GROUP21/a_y'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_PHNG KHM GROUP21/h3_ng k ti khon'), 'Đăng ký tài khoản')
