...
// Wait for the Doctor Link to be visible and click it
...
// Wait for the First Cell of the Doctor Table to be visible and click it
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_PHNG KHM GROUP21/div_Alcool 70                Hot cht Cn 70 _481b02'), 
    10)
