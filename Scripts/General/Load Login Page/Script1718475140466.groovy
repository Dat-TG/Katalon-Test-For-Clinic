...
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_PHNG KHM GROUP21/h3_ng nhp'), 10)

WebUI.verifyElementText(findTestObject('Object Repository/Page_PHNG KHM GROUP21/h3_ng nhp'), 'Đăng nhập')