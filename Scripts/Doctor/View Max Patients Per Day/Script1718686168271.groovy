...
// Click the 'Số bệnh nhân tối đa trong ngày' link
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_PHNG KHM GROUP21/div_S bnh nhn ti a trong ngy        40'), 10)
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_PHNG KHM GROUP21/div_S bnh nhn ti a trong ngy        40'))
