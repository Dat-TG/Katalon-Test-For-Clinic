...
WebUI.setText(findTestObject('Object Repository/Page_PHNG KHM GROUP21/input_service_price'), '-100000')
...
boolean isValidationAlertShown = WebUI.getAttribute(findTestObject('Object Repository/Page_PHNG KHM GROUP21/input_service_price'), 'validationMessage') != ''
