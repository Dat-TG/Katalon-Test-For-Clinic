...
WebUI.setText(findTestObject('Object Repository/Page_PHNG KHM GROUP21/input_service_name'), '')
...
boolean isValidationAlertShown = WebUI.getAttribute(findTestObject('Object Repository/Page_PHNG KHM GROUP21/input_service_name'), 'validationMessage') != ''
