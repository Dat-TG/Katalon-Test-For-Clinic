...
WebUI.setText(findTestObject('Object Repository/Page_PHNG KHM GROUP21/input_n v tnh_Price'), '-10')
...
WebUI.setText(findTestObject('Object Repository/Page_PHNG KHM GROUP21/input_n gi_Quantity'), '300')
...
boolean isValidationAlertShown = WebUI.getAttribute(findTestObject('Object Repository/Page_PHNG KHM GROUP21/input_n v tnh_Price'), 'validationMessage') != ''
