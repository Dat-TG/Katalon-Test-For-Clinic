...
// Load test data
TestData data = findTestData('Data Files/Max Patients Per Day')

for (def index : (0..data.getRowNumbers() - 1)) {
    // Get data from each row
    String numOfPatients = data.getValue('Number of patients', index + 1)
    ...
    try {
		...
		WebUI.setText(findTestObject('Object Repository/Page_PHNG KHM GROUP21/input_Thay i s bnh nhn ti a trong ngy_max'), numOfPatients)
        ...
        if (expectedResult == 'Success') {
			...
			WebUI.waitForElementVisible(findTestObject('Object Repository/Page_PHNG KHM GROUP21/h1_50'), 10)
			WebUI.verifyElementText(findTestObject('Object Repository/Page_PHNG KHM GROUP21/h1_50'), '50')
        } else {
