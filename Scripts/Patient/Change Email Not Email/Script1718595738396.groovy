...
// Set new email empty
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_PHNG KHM GROUP21/input_email_edit_profile'), 10)
WebUI.setText(findTestObject('Object Repository/Page_PHNG KHM GROUP21/input_email_edit_profile'), '13102k2')
...
boolean isValidationAlertShown = WebUI.getAttribute(findTestObject('Object Repository/Page_PHNG KHM GROUP21/input_email_edit_profile'), 'validationMessage') != ''
