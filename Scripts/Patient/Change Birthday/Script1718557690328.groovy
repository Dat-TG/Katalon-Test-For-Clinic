...
// Set date of birth
String dateOfBirth = '10-13-2002' // Replace with the desired date
WebUI.setText(findTestObject('Object Repository/Page_PHNG KHM GROUP21/input_dob_edit_profile'), dateOfBirth)
