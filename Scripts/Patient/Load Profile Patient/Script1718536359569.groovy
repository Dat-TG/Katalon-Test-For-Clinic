...
// Wait for and click on the user icon
...
// Wait for and click on the 'Account' link
...
// Verify the 'Medical History' section
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_PHNG KHM GROUP21/div_Lch s khm bnh                          _d6b530'), 10)
