...
// Set new phone empty
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_PHNG KHM GROUP21/input_phone_edit_profile'), 10)
WebUI.setText(findTestObject('Object Repository/Page_PHNG KHM GROUP21/input_phone_edit_profile'), '')
...
boolean isValidationAlertShown = WebUI.getAttribute(findTestObject('Object Repository/Page_PHNG KHM GROUP21/input_phone_edit_profile'), 'validationMessage') != ''
